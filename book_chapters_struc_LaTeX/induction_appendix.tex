...
\begin{prop}\label{proposition:induction:Induction1} For all $n\in\NN$,  it is true that
\[
...
\noindent
\bfii{Should I use ordinary induction or strong induction?}
...
\noindent
\bfii{ How many base cases are needed?} 
...
\noindent
 \bfii{How do I write the induction step?}
