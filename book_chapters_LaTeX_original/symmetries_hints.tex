...
\noindent Exercise \ref{exercise:symmetries:mercedes}: The rearrangement that doesn't move anything is still considered to be a symmetry: for obvious reasons, it is called the \bfii{ identity}).
