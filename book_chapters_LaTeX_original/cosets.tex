...
Let $G$ be a group and $H$ be a subgroup of $G$.  Define the \term{index}\index{Index of a subgroup}\index{Subgroup!index of} of $H$ in $G$ to be the number of left cosets of $H$ in $G$.  We will denote the index by~$[G:H]$\label{indexofasubgroup}.
\end{defn}  
...
The function $\phi$ is called the \term{Euler} $\phi$-\term{function}\index{Euler $\phi$-function}.
\end{defn}
